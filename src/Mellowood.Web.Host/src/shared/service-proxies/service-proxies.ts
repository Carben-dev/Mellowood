...
export class CMSServiceServiceProxy {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<ListResultDtoOfContentDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ListResultDtoOfContentDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class ListResultDtoOfContentDto implements IListResultDtoOfContentDto {
    items: ContentDto[] | undefined;

    constructor(data?: IListResultDtoOfContentDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
...
export interface IListResultDtoOfContentDto {
    items: ContentDto[] | undefined;
}
...
export class InsertOrUpdateCMSContentInput implements IInsertOrUpdateCMSContentInput {
    id: number;
    title: string;
    description: string;

    constructor(data?: IInsertOrUpdateCMSContentInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): InsertOrUpdateCMSContentInput {
        data = typeof data === 'object' ? data : {};
        let result = new InsertOrUpdateCMSContentInput();
        result.init(data);
        return result;
    }
    ...
    clone(): InsertOrUpdateCMSContentInput {
        const json = this.toJSON();
        let result = new InsertOrUpdateCMSContentInput();
        result.init(json);
        return result;
...
export interface IInsertOrUpdateCMSContentInput {
    id: number;
    title: string;
    description: string;
}
